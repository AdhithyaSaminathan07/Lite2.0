...
<form
  onSubmit={handleFilter}
  className="flex flex-wrap items-center justify-center gap-1 mb-4 bg-white p-2 rounded-md shadow-sm border w-full max-w-md mx-auto"
>
  <div className="flex items-center gap-1">
    <label htmlFor="fromDate" className="text-gray-700 text-xs">
      From:
    </label>
    <input
      id="fromDate"
      ...
      value={fromDate}
      onChange={(e) => setFromDate(e.target.value)}
      className="border rounded-md px-1 py-[2px] text-xs w-[95px] focus:ring-1 focus:ring-indigo-500 outline-none"
    />
  </div>

  <div className="flex items-center gap-1">
    <label htmlFor="toDate" className="text-gray-700 text-xs">
      To:
    </label>
    <input
      id="toDate"
  ...
  <button
    type="submit"
    className="bg-indigo-600 text-white text-xs px-2 py-[3px] rounded-md hover:bg-indigo-700 transition"
  >
    Filter
  </button>
  ...
  <button
    type="button"
    onClick={handleClear}
    className="bg-gray-200 text-gray-700 text-xs px-2 py-[3px] rounded-md hover:bg-gray-300 transition"
  >
    Clear
  </button>
</form>
