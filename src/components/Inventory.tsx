...
//                                 </div>
//                             </div>
//                             {/* --- Start: GST Calculation Display --- */}
//                             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-3 rounded-lg border">
//                                 <div className="space-y-1">
//                                     <label className="text-xs font-medium text-gray-500">GST Amount</label>
//                                     <div className="w-full text-gray-800 font-medium">
//                                         {formatCurrency(gstAmount)}
//                                     </div>
//                                 </div>
//                                 <div className="space-y-1">
//                                     <label className="text-xs font-medium text-gray-500">Total Price (incl. GST)</label>
//                                     <div className="w-full text-gray-900 font-bold text-lg">
//                                         {formatCurrency(Number(formData.sellingPrice) + gstAmount)}
//                                     </div>
//                                 </div>
//                             </div>
...
//                             {/* --- Start: GST Calculation Display (Conditional) --- */}
...
//                             {showCalculation && isGstInclusive && (
//                                  <div className="bg-gray-50 p-4 rounded-lg border animate-in fade-in duration-300">
//                                      <div className="flex justify-between items-center">
//                                          <div>
//                                              <label className="text-sm font-medium text-gray-600 block">Base Price (Excl. GST)</label>
//                                              <p className="text-xs text-gray-500">This is the value that will be saved.</p>
//                                          </div>
...
//                                  </div>
//                             )}
//                             {/* --- End: GST Calculation Display (Conditional) --- */}
//                         </>
//                     )}
//                 </div>
