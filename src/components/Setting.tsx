...
// // (Optional Improvement) Type for the SettingsField component's props
// type SettingsFieldProps = {
//   label: string;
//   value: string;
//   isEditing: boolean;
//   name: keyof FormData; // Use keyof for better type safety
//   onChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
//   type?: string;
// };

// // A reusable component for our form fields, now using the dedicated props type
...
//               <div className="bg-white p-6 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl lg:col-span-2">
//                 <div className="flex items-center gap-x-4">
